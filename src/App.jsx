...
const App = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      // سيقوم Vercel بقراءة هذا المفتاح تلقائياً من الإعدادات التي شرحتها لك
      ...
      const botReply = data.candidates?.[0]?.content?.parts?.[0]?.text || "نظام التحليل يحتاج إلى مفتاح API للعمل.";
    ...
    <div className="min-h-screen bg-[#020408] text-slate-300 font-sans selection:bg-blue-500/30 overflow-x-hidden" dir="rtl">
      ...
      <nav className="sticky top-0 z-[60] bg-[#020408]/80 backdrop-blur-xl border-b border-slate-800/50 px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
             <a href="https://instagram.com/gencazai" target="_blank" rel="noopener noreferrer" className="p-2 hover:bg-slate-800 rounded-lg transition-all text-slate-400 hover:text-pink-500">
               <Instagram size={20} />
             </a>
      ...
      <footer className="max-w-7xl mx-auto py-16 px-8 border-t border-slate-900/50 mt-20 text-center">
         <div className="flex flex-col items-center gap-6">
            ...
            <a href="https://instagram.com/gencazai" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-slate-500 hover:text-pink-500 transition-colors text-xs font-bold">
